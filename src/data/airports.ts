 ...
 * every Canadian province and territory, Mexico, the Caribbean, Central and
 * South America, and the main long-haul gateways in Europe, the Middle East,
 ...
 *  - `state` is the US state code or the Canadian province/territory code.
...
const CA = { country: "Canada", countryCode: "CA" } as const;
...
export const AIRPORTS: Airport[] = [
  ...
  },
  {
    ...
    tz: "America/New_York",
    size: 4,
    keywords: ["Logan", "Massachusetts", "Cambridge", "New England"],
  },
  {
    iata: "PHL",
    icao: "KPHL",
    ...
    tz: "America/New_York",
    size: 4,
    keywords: ["Philly", "Pennsylvania", "South Jersey"],
  },
  {
    iata: "PIT",
    icao: "KPIT",
    ...
    tz: "America/New_York",
    size: 3,
    keywords: ["Pennsylvania", "Steel City"],
  },
  {
    iata: "BWI",
    icao: "KBWI",
  ...
  },
  {
    ...
    tz: "America/New_York",
    size: 3,
    keywords: ["Connecticut", "Windsor Locks", "Springfield", "New Haven"],
  },
  {
    iata: "PVD",
    icao: "KPVD",
    ...
    tz: "America/New_York",
    size: 3,
    keywords: ["Rhode Island", "Warwick", "T.F. Green", "Newport"],
  },
  {
    iata: "BUF",
    icao: "KBUF",
    ...
    tz: "America/New_York",
    size: 3,
    keywords: ["Niagara Falls", "Western New York", "Cheektowaga"],
  },
  {
    iata: "ALB",
    icao: "KALB",
    ...
    tz: "America/New_York",
    size: 2,
    keywords: ["Capital Region", "Upstate New York", "Saratoga Springs"],
  },
  {
    iata: "ROC",
    icao: "KROC",
    ...
    tz: "America/New_York",
    size: 2,
    keywords: ["Upstate New York", "Finger Lakes"],
  },
  {
    iata: "SYR",
    icao: "KSYR",
    ...
    tz: "America/New_York",
    size: 2,
    keywords: ["Upstate New York", "Central New York"],
  },
  {
    iata: "MHT",
    icao: "KMHT",
    ...
    tz: "America/New_York",
    size: 1,
    keywords: ["New Hampshire", "Boston", "Nashua"],
  },
  {
    iata: "PWM",
    icao: "KPWM",
    ...
    tz: "America/New_York",
    size: 2,
    keywords: ["Maine", "Portland Maine", "Jetport"],
  },
  {
    iata: "BTV",
    icao: "KBTV",
    ...
    tz: "America/New_York",
    size: 1,
    keywords: ["Vermont", "South Burlington", "Lake Champlain"],
  },
  ...
  /* ───────────────────────────── US Southeast ───────────────────────────── */
  {
    ...
    tz: "America/New_York",
    size: 5,
    keywords: ["Hartsfield", "Georgia", "Hartsfield-Jackson"],
  },
  {
    iata: "CLT",
    icao: "KCLT",
    ...
    tz: "America/New_York",
    size: 5,
    keywords: ["North Carolina", "Douglas", "Queen City"],
  },
  {
    iata: "MIA",
    icao: "KMIA",
  ...
  },
  {
    ...
    tz: "America/New_York",
    size: 4,
    keywords: ["Tampa Bay", "St. Petersburg", "Clearwater", "Florida"],
  },
  {
    iata: "RSW",
    icao: "KRSW",
  ...
  },
  {
    ...
    tz: "America/New_York",
    size: 2,
    keywords: ["Orlando", "Orlando Sanford", "Central Florida", "Florida"],
  },
  {
    iata: "PIE",
    icao: "KPIE",
    ...
    tz: "America/New_York",
    size: 2,
    keywords: ["Clearwater", "Tampa Bay", "Saint Petersburg", "Florida"],
  },
  {
    iata: "SRQ",
    icao: "KSRQ",
    ...
    tz: "America/New_York",
    size: 3,
    keywords: ["Bradenton", "Siesta Key", "Gulf Coast", "Florida"],
  },
  {
    iata: "PNS",
    icao: "KPNS",
    ...
    tz: "America/Chicago",
    size: 2,
    keywords: ["Florida Panhandle", "Gulf Coast", "Florida"],
  },
  {
    iata: "VPS",
    icao: "KVPS",
  ...
  },
  {
    ...
    tz: "America/New_York",
    size: 1,
    keywords: ["Florida Keys", "The Keys", "Florida"],
  },
  {
    iata: "RDU",
    icao: "KRDU",
    ...
    tz: "America/New_York",
    size: 4,
    keywords: ["Durham", "Chapel Hill", "Research Triangle", "North Carolina"],
  },
  {
    iata: "GSO",
    icao: "KGSO",
    ...
    tz: "America/New_York",
    size: 2,
    keywords: ["Winston-Salem", "High Point", "Triad", "North Carolina"],
  },
  {
    iata: "AVL",
    icao: "KAVL",
    ...
    tz: "America/New_York",
    size: 2,
    keywords: ["Blue Ridge", "Western North Carolina", "North Carolina"],
  },
  {
    iata: "SAV",
    icao: "KSAV",
    ...
    tz: "America/New_York",
    size: 3,
    keywords: ["Hilton Head", "Georgia", "Tybee Island"],
  },
  {
    iata: "CHS",
    icao: "KCHS",
    ...
    tz: "America/New_York",
    size: 3,
    keywords: ["South Carolina", "Lowcountry", "Kiawah", "North Charleston"],
  },
  {
    iata: "MYR",
    icao: "KMYR",
    ...
    tz: "America/New_York",
    size: 2,
    keywords: ["Grand Strand", "South Carolina"],
  },
  {
    iata: "GSP",
    icao: "KGSP",
    ...
    tz: "America/New_York",
    size: 2,
    keywords: ["Spartanburg", "Upstate South Carolina", "South Carolina"],
  },
  {
    iata: "BNA",
    icao: "KBNA",
    ...
    tz: "America/Chicago",
    size: 4,
    keywords: ["Music City", "Tennessee", "Franklin"],
  },
  {
    iata: "MEM",
    icao: "KMEM",
  ...
  },
  {
    ...
    size: 3,
    keywords: ["Kentucky", "Muhammad Ali", "Standiford Field"],
  },
  {
    iata: "CVG",
    icao: "KCVG",
    ...
    tz: "America/New_York",
    size: 3,
    keywords: ["Northern Kentucky", "Hebron", "Covington", "Ohio", "Kentucky"],
  },
  {
    iata: "BHM",
    icao: "KBHM",
    ...
    tz: "America/Chicago",
    size: 2,
    keywords: ["Alabama", "Shuttlesworth"],
  },
  {
    iata: "MSY",
    icao: "KMSY",
    ...
    tz: "America/Chicago",
    size: 4,
    keywords: ["NOLA", "Louisiana", "French Quarter", "Kenner", "Big Easy"],
  },
  {
    iata: "LIT",
    icao: "KLIT",
  ...
  },
  {
    ...
    tz: "America/Chicago",
    size: 1,
    keywords: ["Mississippi", "Medgar Evers"],
  },
  {
    iata: "CRW",
    icao: "KCRW",
  ...
  },
  {
    ...
    tz: "America/New_York",
    size: 3,
    keywords: ["Virginia", "Central Virginia"],
  },
  {
    iata: "ORF",
    icao: "KORF",
    ...
    tz: "America/New_York",
    size: 3,
    keywords: ["Virginia Beach", "Hampton Roads", "Chesapeake", "Virginia"],
  },
  {
    iata: "SJU",
    icao: "TJSJ",
  ...
  },
  {
    ...
    tz: "America/Puerto_Rico",
    size: 1,
    keywords: ["Puerto Rico", "Rincon", "Rincón", "West Puerto Rico"],
  },
  {
    iata: "STT",
    icao: "TIST",
  ...
  /* ───────────────────────────── US Midwest ─────────────────────────────── */
  {
    ...
    tz: "America/Chicago",
    size: 5,
    keywords: ["OHare", "O Hare", "Illinois", "Chicagoland", "Windy City"],
  },
  {
    iata: "MDW",
    icao: "KMDW",
    ...
    tz: "America/Chicago",
    size: 4,
    keywords: ["Midway", "Illinois", "Chicagoland", "South Side"],
  },
  {
    iata: "DTW",
    icao: "KDTW",
  ...
  },
  {
    ...
    tz: "America/Detroit",
    size: 2,
    keywords: ["Michigan", "West Michigan", "Gerald Ford"],
  },
  {
    iata: "MSP",
    icao: "KMSP",
  ...
  },
  {
    ...
    tz: "America/Chicago",
    size: 4,
    keywords: ["Saint Louis", "Lambert", "Missouri"],
  },
  {
    iata: "MCI",
    icao: "KMCI",
    ...
    tz: "America/Chicago",
    size: 4,
    keywords: ["KC", "Missouri", "Kansas", "Overland Park"],
  },
  {
    iata: "IND",
    icao: "KIND",
  ...
  },
  {
    ...
    tz: "America/New_York",
    size: 3,
    keywords: ["Hopkins", "Ohio", "Akron", "Northeast Ohio"],
  },
  {
    iata: "CMH",
    icao: "KCMH",
    ...
    tz: "America/New_York",
    size: 3,
    keywords: ["John Glenn", "Ohio", "Central Ohio"],
  },
  {
    iata: "MKE",
    icao: "KMKE",
    ...
    tz: "America/Chicago",
    size: 3,
    keywords: ["Wisconsin", "Mitchell", "General Mitchell"],
  },
  {
    iata: "MSN",
    icao: "KMSN",
    ...
    tz: "America/Chicago",
    size: 2,
    keywords: ["Wisconsin", "Dane County"],
  },
  {
    iata: "OMA",
    icao: "KOMA",
    ...
    tz: "America/Chicago",
    size: 3,
    keywords: ["Nebraska", "Eppley", "Council Bluffs", "Lincoln"],
  },
  {
    iata: "DSM",
    icao: "KDSM",
  ...
  },
  {
    ...
    tz: "America/Chicago",
    size: 1,
    keywords: ["North Dakota", "Moorhead", "Hector"],
  },
  {
    iata: "FSD",
    icao: "KFSD",
    ...
    tz: "America/Chicago",
    size: 1,
    keywords: ["South Dakota", "Joe Foss Field"],
  },
  ...
  },
  {
    ...
    tz: "America/Chicago",
    size: 4,
    keywords: ["Hobby", "Texas", "Galveston", "Space City"],
  },
  {
    iata: "AUS",
    icao: "KAUS",
    ...
    tz: "America/Chicago",
    size: 4,
    keywords: ["Bergstrom", "Texas", "Hill Country", "Round Rock", "ATX"],
  },
  {
    iata: "SAT",
    icao: "KSAT",
    ...
    tz: "America/Chicago",
    size: 4,
    keywords: ["Texas", "Alamo", "River Walk", "Hill Country"],
  },
  {
    iata: "ELP",
    icao: "KELP",
    ...
    tz: "America/Denver",
    size: 2,
    keywords: ["Texas", "Ciudad Juarez", "Las Cruces", "Fort Bliss"],
  },
  {
    iata: "OKC",
    icao: "KOKC",
  ...
  },
  {
    ...
    tz: "America/Chicago",
    size: 2,
    keywords: ["Oklahoma", "Green Country"],
  },
  {
    iata: "PHX",
    icao: "KPHX",
  ...
  },
  {
    ...
    tz: "America/Phoenix",
    size: 2,
    keywords: ["Arizona", "Southern Arizona", "Sonoran Desert"],
  },
  {
    iata: "ABQ",
    icao: "KABQ",
    ...
    tz: "America/Denver",
    size: 3,
    keywords: ["New Mexico", "Sunport", "Santa Fe"],
  },
  {
    iata: "DEN",
    icao: "KDEN",
  ...
  },
  {
    ...
    tz: "America/Denver",
    size: 2,
    keywords: ["Colorado", "Pikes Peak", "Air Force Academy"],
  },
  {
    iata: "SLC",
    icao: "KSLC",
    ...
    tz: "America/Denver",
    size: 4,
    keywords: ["Utah", "SLC", "Park City", "Wasatch", "Provo"],
  },
  {
    iata: "LAS",
    icao: "KLAS",
  ...
  },
  {
    ...
    tz: "America/Los_Angeles",
    size: 3,
    keywords: ["Lake Tahoe", "Tahoe", "Nevada", "Sparks", "Carson City"],
  },
  ...
  },
  {
    ...
    tz: "America/Los_Angeles",
    size: 2,
    keywords: ["Los Angeles", "Orange County", "South Bay", "California"],
  },
  {
    iata: "SNA",
    icao: "KSNA",
  ...
  },
  {
    ...
    tz: "America/Los_Angeles",
    size: 4,
    keywords: ["Northern California", "Davis", "Lake Tahoe", "California"],
  },
  {
    iata: "PSP",
    icao: "KPSP",
    ...
    tz: "America/Los_Angeles",
    size: 2,
    keywords: ["Coachella Valley", "Palm Desert", "Coachella", "California"],
  },
  {
    iata: "FAT",
    icao: "KFAT",
    ...
    tz: "America/Los_Angeles",
    size: 2,
    keywords: ["Yosemite", "Central Valley", "California"],
  },
  {
    iata: "SEA",
    icao: "KSEA",
  ...
  },
  {
    ...
    tz: "America/Los_Angeles",
    size: 3,
    keywords: ["Washington", "Inland Northwest", "Coeur d'Alene"],
  },
  {
    iata: "PDX",
    icao: "KPDX",
  ...
  },
  {
    ...
    tz: "America/Boise",
    size: 3,
    keywords: ["Idaho", "Treasure Valley", "Sun Valley"],
  },
  {
    iata: "BZN",
    icao: "KBZN",
    ...
    tz: "America/Denver",
    size: 2,
    keywords: ["Yellowstone", "Montana", "Big Sky", "Belgrade"],
  },
  {
    iata: "JAC",
    icao: "KJAC",
  ...
  /* ─────────────────────────── Hawaii, Alaska, Guam ─────────────────────── */
  {
    ...
    tz: "Pacific/Honolulu",
    size: 4,
    keywords: ["Hawaii", "Oahu", "Waikiki", "Inouye", "Pearl Harbor"],
  },
  {
    iata: "OGG",
    icao: "PHOG",
    ...
    tz: "Pacific/Honolulu",
    size: 3,
    keywords: ["Maui", "Hawaii", "Wailea", "Kaanapali", "Lahaina", "Kihei"],
  },
  {
    iata: "KOA",
    icao: "PHKO",
    ...
    tz: "Pacific/Honolulu",
    size: 2,
    keywords: ["Kona", "Big Island", "Hawaii", "Hawaii Island", "Waikoloa"],
  },
  {
    iata: "LIH",
    icao: "PHLI",
    ...
    tz: "Pacific/Honolulu",
    size: 2,
    keywords: ["Kauai", "Hawaii", "Poipu", "Princeville", "Lihu'e"],
  },
  {
    iata: "ITO",
    icao: "PHTO",
  ...
  },
  {
    ...
    size: 3,
    keywords: ["Alaska", "Ted Stevens", "Denali"],
  },
  {
    iata: "FAI",
    icao: "PAFA",
    ...
    tz: "America/Anchorage",
    size: 1,
    keywords: ["Alaska", "Interior Alaska", "Northern Lights"],
  },
  {
    iata: "JNU",
    icao: "PAJN",
    ...
    tz: "America/Juneau",
    size: 1,
    keywords: ["Alaska", "Southeast Alaska", "Inside Passage"],
  },
  {
    iata: "GUM",
    icao: "PGUM",
  ...
  /* ─────────────────────────────── Canada ───────────────────────────────── */
  /* `state` carries the two-letter province/territory code, the same way it
     carries the state code for US airports. Every province and territory is
     represented so a Canadian traveler finds their own airport in search. */
  // Ontario
  {
    iata: "YYZ",
    icao: "CYYZ",
    ...
    tz: "America/Toronto",
    size: 5,
    keywords: ["Pearson", "Ontario", "Mississauga", "GTA", "Greater Toronto"],
  },
  {
    iata: "YTZ",
    icao: "CYTZ",
  ...
  },
  {
    ...
    tz: "America/Toronto",
    size: 2,
    keywords: ["Hamilton", "Ontario", "Niagara", "Burlington", "Toronto"],
  },
  {
    iata: "YOW",
    icao: "CYOW",
    ...
    tz: "America/Toronto",
    size: 3,
    keywords: ["Ontario", "Gatineau", "Canadian capital", "Parliament Hill"],
  },
  {
    iata: "YKF",
    icao: "CYKF",
    ...
    tz: "America/Toronto",
    size: 1,
    keywords: ["Waterloo", "Kitchener", "Cambridge", "Guelph", "Ontario"],
  },
  {
    iata: "YXU",
    icao: "CYXU",
    ...
    tz: "America/Toronto",
    size: 1,
    keywords: ["London Ontario", "Southwestern Ontario"],
  },
  {
    iata: "YQG",
    icao: "CYQG",
    ...
    tz: "America/Toronto",
    size: 1,
    keywords: ["Windsor", "Ontario", "Detroit", "border"],
  },
  {
    iata: "YQT",
    icao: "CYQT",
    ...
    tz: "America/Toronto",
    size: 1,
    keywords: ["Northwestern Ontario", "Lake Superior"],
  },
  {
    iata: "YSB",
    icao: "CYSB",
    ...
    tz: "America/Toronto",
    size: 1,
    keywords: ["Northern Ontario", "Sudbury"],
  },
  // Quebec
  {
    iata: "YUL",
    ...
    tz: "America/Toronto",
    size: 4,
    keywords: ["Montréal", "Quebec", "Québec", "Trudeau", "Dorval"],
  },
  {
    iata: "YQB",
    icao: "CYQB",
    ...
    tz: "America/Toronto",
    size: 2,
    keywords: ["Québec", "Quebec", "Jean Lesage", "Old Quebec", "Vieux-Québec"],
  },
  {
    iata: "YTM",
    icao: "CYFJ",
    ...
    tz: "America/Toronto",
    size: 1,
    keywords: ["Tremblant", "Laurentians", "ski", "Quebec", "Québec"],
  },
  // British Columbia
  {
    iata: "YVR",
    ...
    size: 4,
    keywords: ["British Columbia", "BC", "Richmond", "Whistler"],
  },
  {
    iata: "YYJ",
    icao: "CYYJ",
  ...
  },
  {
    ...
    tz: "America/Vancouver",
    size: 1,
    keywords: ["Fraser Valley", "British Columbia", "BC", "Vancouver"],
  },
  {
    iata: "YXS",
    icao: "CYXS",
    ...
    tz: "America/Vancouver",
    size: 1,
    keywords: ["Northern British Columbia", "BC", "Cariboo"],
  },
  {
    iata: "YQQ",
    icao: "CYQQ",
    ...
    tz: "America/Vancouver",
    size: 1,
    keywords: ["Vancouver Island", "Courtenay", "British Columbia", "BC"],
  },
  {
    iata: "YCD",
    icao: "CYCD",
    ...
    tz: "America/Vancouver",
    size: 1,
    keywords: ["Vancouver Island", "British Columbia", "BC"],
  },
  // Alberta
  {
    iata: "YYC",
  ...
  },
  {
    ...
    tz: "America/Edmonton",
    size: 3,
    keywords: ["Alberta", "Leduc", "Jasper", "West Edmonton Mall"],
  },
  {
    iata: "YMM",
    icao: "CYMM",
    ...
    tz: "America/Edmonton",
    size: 1,
    keywords: ["Alberta", "Wood Buffalo", "oil sands"],
  },
  {
    iata: "YQU",
    icao: "CYQU",
    ...
    tz: "America/Edmonton",
    size: 1,
    keywords: ["Alberta", "Peace Country"],
  },
  {
    iata: "YQL",
    icao: "CYQL",
    ...
    tz: "America/Edmonton",
    size: 1,
    keywords: ["Southern Alberta", "Waterton"],
  },
  // Saskatchewan
  {
    iata: "YXE",
    ...
    tz: "America/Regina",
    size: 2,
    keywords: ["Saskatchewan", "Diefenbaker"],
  },
  {
    iata: "YQR",
    icao: "CYQR",
    ...
    tz: "America/Regina",
    size: 2,
    keywords: ["Saskatchewan", "provincial capital"],
  },
  // Manitoba
  {
    iata: "YWG",
    ...
    tz: "America/Winnipeg",
    size: 3,
    keywords: ["Manitoba", "Richardson", "The Forks"],
  },
  {
    iata: "YBR",
    icao: "CYBR",
  ...
  },
  {
    ...
    tz: "America/Halifax",
    size: 1,
    keywords: ["Cape Breton", "Nova Scotia", "Cabot Trail"],
  },
  {
    iata: "YQM",
    icao: "CYQM",
    ...
    tz: "America/Moncton",
    size: 1,
    keywords: ["New Brunswick", "Maritimes", "Dieppe", "Bay of Fundy"],
  },
  {
    iata: "YSJ",
    icao: "CYSJ",
    ...
    tz: "America/Moncton",
    size: 1,
    keywords: ["New Brunswick", "Bay of Fundy", "Maritimes"],
  },
  {
    iata: "YFC",
    icao: "CYFC",
    ...
    tz: "America/Moncton",
    size: 1,
    keywords: ["New Brunswick", "provincial capital", "Maritimes"],
  },
  {
    iata: "YYG",
    icao: "CYYG",
  ...
  },
  {
    ...
    tz: "America/St_Johns",
    size: 1,
    keywords: ["Newfoundland", "Gros Morne", "Corner Brook"],
  },
  {
    iata: "YYR",
    icao: "CYYR",
    ...
    size: 1,
    keywords: ["Labrador", "Newfoundland and Labrador"],
  },
  // Territories
  {
    iata: "YXY",
    ...
    size: 1,
    keywords: ["Yukon", "northern lights", "Klondike"],
  },
  {
    iata: "YZF",
    icao: "CYZF",
  ...
  },
  {
    ...
    tz: "America/Iqaluit",
    size: 1,
    keywords: ["Nunavut", "Baffin Island", "Arctic"],
  },
  ...
  },
  {
    ...
    tz: "America/Mexico_City",
    size: 3,
    keywords: ["Jalisco", "Miguel Hidalgo", "Tlaquepaque", "Zapopan"],
  },
  {
    iata: "MTY",
    icao: "MMMY",
    ...
    size: 3,
    keywords: ["Nuevo Leon", "Nuevo León", "Mariano Escobedo", "Apodaca"],
  },
  {
    iata: "SJD",
    icao: "MMSD",
  ...
  },
  {
    ...
    tz: "America/Cancun",
    size: 2,
    keywords: ["Quintana Roo", "Riviera Maya", "Playa del Carmen", "scuba"],
  },
  {
    iata: "OAX",
    icao: "MMOX",
    ...
    tz: "America/Mexico_City",
    size: 2,
    keywords: ["Oaxaca City", "Xoxocotlán", "Xoxocotlan"],
  },
  {
    iata: "MID",
    icao: "MMMD",
  ...
  },
  {
    ...
    tz: "America/Jamaica",
    size: 3,
    keywords: ["MoBay", "Negril", "Ocho Rios", "Sangster"],
  },
  {
    iata: "KIN",
    icao: "MKJP",
    ...
    tz: "America/Jamaica",
    size: 2,
    keywords: ["Norman Manley", "Port Royal"],
  },
  {
    iata: "NAS",
    icao: "MYNN",
  ...
  },
  {
    ...
    tz: "America/Curacao",
    size: 2,
    keywords: ["Curacao", "Hato", "ABC islands", "Dutch Caribbean"],
  },
  {
    iata: "SXM",
    icao: "TNCM",
  ...
  },
  {
    ...
    tz: "America/Cayman",
    size: 2,
    keywords: ["Grand Cayman", "Cayman", "Seven Mile Beach"],
  },
  {
    iata: "PLS",
    icao: "MBPV",
    ...
    size: 2,
    keywords: ["Turks and Caicos", "Provo", "Grace Bay", "TCI"],
  },
  {
    iata: "BGI",
    icao: "TBPB",
    ...
    tz: "America/Barbados",
    size: 2,
    keywords: ["Barbados", "Christ Church", "Grantley Adams"],
  },
  {
    iata: "POS",
    icao: "TTPP",
    ...
    size: 2,
    keywords: ["Trinidad", "Piarco", "Tobago", "Carnival"],
  },
  {
    iata: "HAV",
    icao: "MUHA",
    ...
    tz: "America/Havana",
    size: 2,
    keywords: ["Jose Marti", "La Habana", "Cuba", "Old Havana"],
  },
  ...
  /* ─────────────────────────── Central America ──────────────────────────── */
  {
    ...
    tz: "America/Panama",
    size: 4,
    keywords: ["Tocumen", "Panama", "Panama Canal", "Ciudad de Panama"],
  },
  {
    iata: "SJO",
    icao: "MROC",
  ...
  },
  {
    ...
    tz: "America/Costa_Rica",
    size: 2,
    keywords: ["Guanacaste", "Tamarindo", "Papagayo", "Nosara", "Costa Rica"],
  },
  {
    iata: "GUA",
    icao: "MGGT",
    ...
    size: 3,
    keywords: ["La Aurora", "Antigua Guatemala", "Guatemala"],
  },
  {
    iata: "SAL",
    icao: "MSLP",
  ...
  },
  {
    ...
    size: 1,
    keywords: ["Roatán", "Bay Islands", "West Bay", "Honduras", "scuba"],
  },
  ...
  /* ───────────────────────────── South America ──────────────────────────── */
  {
    ...
    tz: "America/Bogota",
    size: 4,
    keywords: ["Bogotá", "El Dorado", "Colombia"],
  },
  {
    iata: "MDE",
    icao: "SKRG",
  ...
  },
  {
    ...
    tz: "America/Bogota",
    size: 2,
    keywords: ["Rafael Nunez", "Colombia", "Bocagrande", "Caribbean coast"],
  },
  {
    iata: "LIM",
    icao: "SPJC",
  ...
  },
  {
    ...
    size: 3,
    keywords: ["Ecuador", "Tababela", "Mariscal Sucre", "Andes"],
  },
  {
    iata: "GYE",
    icao: "SEGU",
    ...
    tz: "America/Guayaquil",
    size: 2,
    keywords: ["Ecuador", "Galapagos", "Galápagos", "Jose Joaquin de Olmedo"],
  },
  {
    iata: "GRU",
    icao: "SBGR",
    ...
    size: 4,
    keywords: ["São Paulo", "Guarulhos", "Brazil", "Brasil", "Sampa"],
  },
  {
    iata: "GIG",
    icao: "SBGL",
  ...
  },
  {
    ...
    size: 4,
    keywords: ["Ezeiza", "Argentina", "Palermo", "Recoleta", "Patagonia"],
  },
  {
    iata: "MVD",
    icao: "SUMU",
    ...
    size: 2,
    keywords: ["Uruguay", "Carrasco", "Punta del Este"],
  },
  ...
  },
  {
    ...
    tz: "Europe/London",
    size: 4,
    keywords: ["Gatwick", "England", "UK", "Britain", "Crawley", "Brighton"],
  },
  {
    iata: "STN",
    icao: "EGSS",
    ...
    tz: "Europe/London",
    size: 3,
    keywords: ["Stansted", "England", "UK", "Cambridge", "Essex"],
  },
  {
    iata: "MAN",
    icao: "EGCC",
    ...
    tz: "Europe/London",
    size: 4,
    keywords: ["England", "UK", "Liverpool", "Northern England", "Ringway"],
  },
  {
    iata: "EDI",
    icao: "EGPH",
    ...
    tz: "Europe/London",
    size: 3,
    keywords: ["Scotland", "UK", "Glasgow", "Highlands"],
  },
  {
    iata: "DUB",
    icao: "EIDW",
    ...
    tz: "Europe/Dublin",
    size: 4,
    keywords: ["Ireland", "Eire", "Temple Bar", "US preclearance"],
  },
  {
    iata: "SNN",
    icao: "EINN",
  ...
  },
  {
    ...
    tz: "Europe/Paris",
    size: 4,
    keywords: ["Orly", "France", "Île-de-France", "Ile-de-France"],
  },
  {
    iata: "NCE",
    icao: "LFMN",
  ...
  },
  {
    ...
    tz: "Europe/Zurich",
    size: 4,
    keywords: ["Zürich", "Kloten", "Switzerland", "Swiss Alps", "Lucerne"],
  },
  {
    iata: "GVA",
    icao: "LSGG",
  ...
  },
  {
    ...
    tz: "Europe/Vienna",
    size: 4,
    keywords: ["Wien", "Schwechat", "Austria", "Bratislava"],
  },
  {
    iata: "MAD",
    icao: "LEMD",
    ...
    tz: "Europe/Madrid",
    size: 4,
    keywords: ["Barajas", "Spain", "España", "Adolfo Suarez"],
  },
  {
    iata: "BCN",
    icao: "LEBL",
    ...
    tz: "Europe/Madrid",
    size: 4,
    keywords: ["El Prat", "Catalonia", "Catalunya", "Spain", "Costa Brava"],
  },
  {
    iata: "AGP",
    icao: "LEMG",
  ...
  },
  {
    ...
    tz: "Europe/Lisbon",
    size: 4,
    keywords: ["Lisboa", "Portela", "Portugal", "Cascais", "Sintra"],
  },
  {
    iata: "OPO",
    icao: "LPPR",
  ...
  },
  {
    ...
    tz: "Europe/Rome",
    size: 2,
    keywords: ["Ciampino", "G. B. Pastine", "Roma", "Italy", "Italia"],
  },
  {
    iata: "MXP",
    icao: "LIMC",
  ...
  },
  {
    ...
    tz: "Europe/Rome",
    size: 3,
    keywords: ["Linate", "Milano", "Lombardy", "Italy", "Italia"],
  },
  {
    iata: "VCE",
    icao: "LIPZ",
    ...
    tz: "Europe/Rome",
    size: 3,
    keywords: ["Venezia", "Marco Polo", "Tessera", "Veneto", "Italy", "Italia"],
  },
  {
    iata: "NAP",
    icao: "LIRN",
  ...
  },
  {
    ...
    tz: "Europe/Stockholm",
    size: 4,
    keywords: ["Arlanda", "Sweden", "Sverige", "Uppsala", "Scandinavia"],
  },
  {
    iata: "OSL",
    icao: "ENGM",
    ...
    tz: "Europe/Oslo",
    size: 4,
    keywords: ["Gardermoen", "Norway", "Norge", "Scandinavia", "fjords"],
  },
  {
    iata: "HEL",
    icao: "EFHK",
    ...
    tz: "Europe/Helsinki",
    size: 3,
    keywords: ["Vantaa", "Helsinki-Vantaa", "Finland", "Suomi", "Lapland"],
  },
  {
    iata: "KEF",
    icao: "BIKF",
  ...
  },
  {
    ...
    tz: "Europe/Warsaw",
    size: 3,
    keywords: ["Warszawa", "Chopin", "Okęcie", "Okecie", "Poland", "Polska"],
  },
  {
    iata: "KRK",
    icao: "EPKK",
  ...
  },
  {
    ...
    tz: "Europe/Budapest",
    size: 3,
    keywords: ["Ferenc Liszt", "Ferihegy", "Hungary", "Magyarország", "Danube"],
  },
  {
    iata: "ZAG",
    icao: "LDZA",
    ...
    tz: "Europe/Zagreb",
    size: 2,
    keywords: ["Franjo Tudman", "Pleso", "Croatia", "Hrvatska"],
  },
  {
    iata: "DBV",
    icao: "LDDU",
  ...
  },
  {
    ...
    tz: "Asia/Qatar",
    size: 4,
    keywords: ["Hamad", "Qatar", "West Bay", "The Pearl", "Gulf"],
  },
  {
    iata: "TLV",
    icao: "LLBG",
    ...
    tz: "Asia/Jerusalem",
    size: 4,
    keywords: ["Ben-Gurion", "Lod", "Israel", "Jerusalem", "Jaffa", "Haifa"],
  },
  {
    iata: "AMM",
    icao: "OJAI",
    ...
    tz: "Asia/Amman",
    size: 3,
    keywords: ["Queen Alia", "Jordan", "Petra", "Dead Sea", "Wadi Rum"],
  },
  {
    iata: "CAI",
    icao: "HECA",
    ...
    tz: "Africa/Cairo",
    size: 4,
    keywords: ["Egypt", "Giza", "Pyramids", "Heliopolis", "Nile", "Al Qahirah"],
  },
  {
    iata: "CMN",
    icao: "GMMN",
  ...
  },
  {
    ...
    tz: "Africa/Nairobi",
    size: 3,
    keywords: ["Jomo Kenyatta", "Kenya", "safari", "Masai Mara", "East Africa"],
  },
  {
    iata: "ADD",
    icao: "HAAB",
    ...
    size: 3,
    keywords: ["Bole", "Ethiopia", "East Africa", "Horn of Africa"],
  },
  {
    iata: "LOS",
    icao: "DNMM",
  ...
  },
  {
    ...
    tz: "Africa/Accra",
    size: 2,
    keywords: ["Kotoka", "Ghana", "West Africa", "Osu"],
  },
  ...
  /* ──────────────────────────────── Asia ────────────────────────────────── */
  {
    ...
    tz: "Asia/Tokyo",
    size: 4,
    keywords: ["Narita", "Chiba", "Japan", "Nippon", "Nihon"],
  },
  {
    iata: "HND",
    icao: "RJTT",
  ...
  },
  {
    ...
    tz: "Asia/Shanghai",
    size: 4,
    keywords: ["Pudong", "China", "The Bund", "Lujiazui"],
  },
  {
    iata: "HKG",
    icao: "VHHH",
  ...
  },
  {
    ...
    tz: "Asia/Taipei",
    size: 4,
    keywords: ["Taoyuan", "Taiwan", "Republic of China", "Formosa"],
  },
  {
    iata: "SIN",
    icao: "WSSS",
    ...
    tz: "Asia/Singapore",
    size: 4,
    keywords: ["Changi", "Jewel", "Marina Bay", "Sentosa", "Southeast Asia"],
  },
  {
    iata: "BKK",
    icao: "VTBS",
...
const SEARCH_INDEX: SearchIndexEntry[] = AIRPORTS.map((a) => {
  ...
  const extras = [
    ...
    a.country,
    a.icao,
    a.metro ? METRO_LABELS[a.metro] : undefined,
  ]
...
function rankEntry(e: SearchIndexEntry, q: string): number | null {
  ...
  if (e.haystack.some((h) => h.split(" ").some((w) => w.startsWith(q))))
    return 3;
...
export function searchAirports(query: string, limit = 8): Airport[] {
  ...
  if (!q)
    return [...AIRPORTS]
      .sort(
        (a, b) =>
          Number(b.countryCode === "US") - Number(a.countryCode === "US") ||
          bySizeThenCity(a, b),
      )
      .slice(0, limit);
  ...
  scored.sort(
    (x, y) => x.rank - y.rank || bySizeThenCity(x.airport, y.airport),
  );
...
export function getAirportsForCity(cityOrMetro: string): Airport[] {
  ...
  for (const [code, terms] of Object.entries(METRO_TERMS)) {
    if (terms.includes(q) && AIRPORTS_BY_METRO[code])
      return AIRPORTS_BY_METRO[code];
  }
...
export const TOP_US_AIRPORTS: Airport[] = AIRPORTS.filter(
  (a) => a.countryCode === "US" && a.size >= 4,
).sort(bySizeThenCity);
